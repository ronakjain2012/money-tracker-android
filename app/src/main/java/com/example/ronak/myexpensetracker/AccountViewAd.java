...
public class AccountViewAd extends BaseAdapter {
    private static LayoutInflater inflater = null;
    String[] title, time, day, month, year, desc, type, amt;
    Context context;

    AccountViewAd(AccountView mainActivity, String[] tile, String[] time, String[] day, String[] month, String[] year, String[] desc, String[] type, String[] amt) {
